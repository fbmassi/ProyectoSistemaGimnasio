 ...
 * @author francobmassi
 */
public class GestionNuevoLotePesas extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        botonMostrarTiposDePesas = new javax.swing.JButton();
        ...
        botonCrearLotePesa = new javax.swing.JButton();
        ...
        botonMostrarTiposDePesas.setText("MOSTRAR TIPOS DE PESAS");
        botonMostrarTiposDePesas.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                botonMostrarTiposDePesasActionPerformed(evt);
            }
        });
        ...
        jLabel2.setText("NUEVO LOTE DE PESAS");
        ...
        fechaDeCreacion.setText("Fecha de creacion...");
        ...
        botonCrearLotePesa.setText("CREAR LOTE PESAS");
        botonCrearLotePesa.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                botonCrearLotePesaActionPerformed(evt);
            }
        });
        ...
        botonEliminarLotes.setText("ELIMINAR LOTES DE PESAS");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(botonCrearLotePesa, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    ...
                    .addComponent(botonMostrarTiposDePesas, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addComponent(botonMostrarTiposDePesas)
                .addGap(24, 24, 24)
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(botonCrearLotePesa)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void botonMostrarTiposDePesasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonMostrarTiposDePesasActionPerformed
        String devolver = "";
        for (Articulo art: soporteTécnico.getArticulos()){
            if (art instanceof Pesa) {
                Pesa pesa = (Pesa) art;
                devolver += "<p>ARTICULO: " + art.getTipo() + " - " + pesa.getMarca()
                + " - " + pesa.getTipoAmortizacion() + " - " + pesa.getDuracion()
                + " - " + pesa.getUso() + " - " + pesa.getPeso() + ".</p>";
            }
        }
        resultadosDeBusqueda.setText(strHTML(devolver));
    }//GEN-LAST:event_botonMostrarTiposDePesasActionPerformed
    ...
    private void botonCrearLotePesaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonCrearLotePesaActionPerformed
        ...
        try {
            if (!tipo_amortizacion.equals("POR USO") && !tipo_amortizacion.equals("POR FECHA")) {
                ...
                admin.agregarArticulos(sedeSeleccionada, "PESA", fabricante, tipo_amortizacion, fecha, cantidadSTR, pesoSTR, usoSTR, null, null, null);
            }
    ...
    }//GEN-LAST:event_botonCrearLotePesaActionPerformed
    ...
    private void botonEliminarLotesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonEliminarLotesActionPerformed
        ...
        try {
            if (!tipo_amortizacion.equals("POR USO") && !tipo_amortizacion.equals("POR FECHA")) {
                ...
                //admin.agregarArticulos("Recoleta", "PESA", "Gadnic", "Por uso", "2023-12-06", "50", "3", "De tobillera", null, null, null);
                admin.eliminarArticuloDeSede(sedeSeleccionada, "PESA", fabricante, tipo_amortizacion, pesoSTR, usoSTR, null, null, null);
            }
        } catch (DateTimeParseException e) {
            IngresoErroneo ingresoErroneo = new IngresoErroneo();
            ingresoErroneo.setVisible(true);
    ...
    private javax.swing.JButton botonCrearLotePesa;
    private javax.swing.JButton botonEliminarLotes;
    private javax.swing.JButton botonMostrarTiposDePesas;
